...
*/
            ...
            for (int x = 0; x < width; x ++) {
                for (int y = 0; y < height; y ++) {
                    if (mapFlags[x,y] == 0 && map[x,y] == tileType) {
                        List<Coord> newRegion = GetRegionTiles(mapFlags,x,y);
        ...
        */
        List<Coord> GetRegionTiles(int [,] mapFlags,int startX, int startY) {
            ...
            mapFlags [startX, startY] = 1;//flags to check if a tile has been visited or not
    ...
    */
        ...
        class Room : IComparable<Room> {
            ...
            class roomTile{
                public tileType roomTyleAssignment;
                public Coord coord;
